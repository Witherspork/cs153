; generated from: hw4programs/run54.oat
...
define i64 @f(i64 %_x132, i64 %_x229, i64 %_x326, i64 %_x423, i64 %_x520, i64 %_x617, i64 %_x714, i64 %_x811) {
  ...
  store i64 %_x520, i64* %_x521
  store i64 %_x617, i64* %_x618
  store i64 %_x714, i64* %_x715
  store i64 %_x811, i64* %_x812
...
define i64 @program(i64 %_argc4, { i64, [0 x i8*] }* %_argv1) {
  ...
  %_unop8 = sub i64 0, 4
  %_unop9 = sub i64 0, 5
  %_result10 = call i64 @f(i64 1, i64 2, i64 3, i64 4, i64 5, i64 %_unop9, i64 %_unop8, i64 %_unop7)
  ret i64 %_result10
}
